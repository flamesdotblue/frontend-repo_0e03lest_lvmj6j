    ...
    <section className="relative min-h-[90vh] w-full overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 pt-24 md:grid-cols-2 md:gap-6 md:pt-28">
        ...
        <div className="relative z-10">
          ...
          <h1 className="mt-5 font-[800] leading-tight tracking-tight text-white" style={{ fontFamily: 'Inter, Manrope, system-ui' }}>
            <span className="text-4xl sm:text-5xl md:text-6xl">Agentic AI that sells, books, and supports — 24/7.</span>
          </h1>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-300 sm:text-lg">
            Launch your own AI agents that call leads, manage schedules, and handle customers — fully autonomous, on brand, and always online.
          </p>
